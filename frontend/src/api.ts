...
export function buildSecurityPack(payload: Record<string, unknown>): Promise<Record<string, any>> {
  return jsonRequest("/api/security/pack", { method: "POST", body: JSON.stringify(payload) });
}
...
export function generatePreferences(payload: Record<string, unknown>): Promise<Record<string, any>> {
  return jsonRequest("/api/preference/starter", { method: "POST", body: JSON.stringify(payload) });
}
...
export function trainHfDpo(payload: Record<string, unknown>): Promise<{ job: JobStatus }> {
  return jsonRequest("/api/train/hf-dpo", { method: "POST", body: JSON.stringify(payload) });
}
...
export function remoteStatus(): Promise<Record<string, any>> {
